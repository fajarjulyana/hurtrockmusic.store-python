...
- [CHAT] **Chat**: Customer service dan komunikasi
- [INFO] **Pesanan**: Manajemen order dan fulfillment
...
- [MUSIC] **Aksesoris**: Pick, cable, stand, case
...
**Greeting**:
"Halo! Selamat datang di Hurtrock Music Store. Ada alat musik yang sedang dicari? [MUSIC]"
