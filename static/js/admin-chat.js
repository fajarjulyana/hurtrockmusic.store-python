...
class AdminChat {
    ...
    setupWebSocketForRoom(roomName) {
        ...
        if (window.location.hostname.includes('replit.dev')) {
            ...
            // Fallback URL - subdomain approach
            ...
            // Additional fallback - direct port access
            wsUrls.push(`ws://${currentHost.split('.')[0]}.replit.dev:8000/ws/chat/${roomName}/?token=${this.chatToken}`);
        } else {
