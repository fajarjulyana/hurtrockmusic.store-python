...
# Updated start script menggunakan server.py
cat > start_server.sh << 'EOF'
#!/bin/bash

# Universal start script for Hurtrock Music Store using server.py
...
echo "[RUNNING] Starting all services via server.py..."
...
rem Execute the main server script
echo [RUNNING] Starting all services via server.py...
%PYTHON_CMD% server.py
EOF
