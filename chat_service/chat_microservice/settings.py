...
def build_allowed_hosts():
    ...
    # Add common domain patterns for cloudflare tunnels
    hosts.extend([
        'kasir.fajarmandiri.store',
        'fajarmandiri.store',
        '*.fajarmandiri.store',
    ])
    
    # In development, allow all hosts for maximum compatibility
    # In production, use explicit allowlist for security
    if DEBUG:
        hosts.append('*')
...
def build_cors_origins():
    ...
    # Add specific domains for cloudflare tunnels
    origins.extend([
        "https://kasir.fajarmandiri.store",
        "http://kasir.fajarmandiri.store",
        "https://fajarmandiri.store",
        "http://fajarmandiri.store",
    ])
