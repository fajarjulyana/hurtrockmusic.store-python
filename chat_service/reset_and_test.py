...
def test_database_connection():
    ...
    try:
        with connection.cursor() as cursor:
            ...
            print(f"✅ Database connected: {result[0] if result else 'Unknown'}")
        return True
    except Exception as e:
...
if __name__ == '__main__':
    print("🚀 Chat Service Reset & Test Script")
    print("=" * 50)
